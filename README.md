[![Build Status](https://dev.azure.com/asmith84/ContosoAir/_apis/build/status/asmithgt.ContosoAir?branchName=master)](https://dev.azure.com/asmith84/ContosoAir/_build/latest?definitionId=1&branchName=master)
